        ...
        <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap', justifyContent: 'center', width: '100%', maxWidth: 900 }}>
          ...
          >
            <div style={{ lineHeight: 1 }}>
              <span style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 34, fontWeight: 700, color: '#1a0a00', letterSpacing: '-0.02em' }}>Canelle</span>
              <span style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 34, fontWeight: 700, color: '#F49306', letterSpacing: '-0.02em' }}>.visuels</span>
            </div>
            <div style={{
              fontSize: 12, color: '#7a4a3a', fontFamily: 'Space Grotesk, sans-serif',
              marginTop: 12, letterSpacing: '0.06em', fontWeight: 500
            }}>{T.cv_sub}</div>
            <div style={{ marginTop: 24, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              {['URSSAF', 'Factures', 'Historique', 'Objectifs'].map((tag, i) => (
                <span key={tag} style={{
                  fontSize: 11, padding: '3px 10px', borderRadius: 100,
                  background: ['rgba(244,147,6,0.12)','rgba(224,133,142,0.12)','rgba(165,187,26,0.12)','rgba(109,184,190,0.12)'][i],
                  color: ['#F49306','#E0858E','#A5BB1A','#6DB8BE'][i],
                  border: 'none', fontFamily: 'Space Grotesk, sans-serif', fontWeight: 600,
    ...
    <div
      ...
      style={{
        ...
        background: isVista
          ...
          : `linear-gradient(90deg, #F49306 0px, #F49306 4px, #ffffff 4px, #ffffff 100%)`,
        border: isVista
          ? `1.5px solid ${hovered ? '#6ab4ff' : 'rgba(106,180,255,0.25)'}`
          : 'none',
        borderRadius: isVista ? 16 : 12,
        boxShadow: isVista
